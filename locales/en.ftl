...
email-session-accepted-body = Dear $NAME,
  ...
  If your session will be presented in a language that will require subtitles, please make sure your pre-recorded presentation arrives to the team in-time to [produce subtitles](https://rustfest.global/cfp/#supported-languages) for the live airing of the talk. This typically means you should send your final recording at least 10 days ahead of the event. The language of presentations at $EVENT_TITLE is: Spanish or English, with two-way live translation.
